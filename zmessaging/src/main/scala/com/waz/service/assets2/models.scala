...
import com.waz.model.AssetMetaData.{HasDimensions, HasDuration, Image}
...
//  case object Empty extends AssetMetadata
//  case class ImageMetadata(dimensions: Dim2, tag: ImageTag) extends AssetMetadata
//  case class AudioMetadata(duration: Duration, loudness: Loudness) extends AssetMetadata
//  case class VideoMetadata(dimensions: Dim2, duration: Duration) extends AssetMetadata
//
//  sealed trait AssetData {
//    val id: AssetId
//    val token: AssetToken
//    val otrKey: AESKey
//    val sha: Sha256
...
//                         override val token: AssetToken,
//                         override val otrKey: AESKey,
//                         override val sha: Sha256,
//                         override val encryption: EncryptionAlgorithm,
//                         preview: AssetId,
...
//                       ) extends AssetData
//
//  case class ProxyAsset(proxyPath: String, asset: AssetData)
//
//
//  case class AssetData2(id:          AssetId               = AssetId(),
